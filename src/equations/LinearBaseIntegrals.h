...
protected:
    ...
    void init() override {
        MAP(values,0,0,0,0) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,0,0,1,0) = -dz / asREAL(24);
        ...
        MAP(values,0,0,2,0) = -dy / asREAL(24);
        ...
        MAP(values,0,1,0,0) = -dz / asREAL(24);
        ...
        MAP(values,0,1,1,0) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,0,1,2,0) = -dx / asREAL(24);
        ...
        MAP(values,0,2,0,0) = -dy / asREAL(24);
        ...
        MAP(values,0,2,1,0) = -dx / asREAL(24);
        ...
        MAP(values,0,2,2,0) = -1 / dz * dy * dx / asREAL(36);
        ...
        MAP(values,1,0,0,0) = dz * dy / dx / asREAL(36);
        MAP(values,1,0,0,1) = dz * dy / dx / asREAL(36);
        ...
        MAP(values,1,0,1,0) = dz / asREAL(24);
        MAP(values,1,0,1,1) = -dz / asREAL(24);
        ...
        MAP(values,1,0,2,0) = dy / asREAL(24);
        MAP(values,1,0,2,1) = -dy / asREAL(24);
        ...
        MAP(values,1,1,0,0) = -dz / asREAL(24);
        MAP(values,1,1,0,1) = dz / asREAL(24);
        ...
        MAP(values,1,1,1,0) = -dz / dy * dx / asREAL(18);
        MAP(values,1,1,1,1) = -dz / dy * dx / asREAL(18);
        ...
        MAP(values,1,1,2,0) = -dx / asREAL(12);
        MAP(values,1,1,2,1) = -dx / asREAL(12);
        ...
        MAP(values,1,2,0,0) = -dy / asREAL(24);
        MAP(values,1,2,0,1) = dy / asREAL(24);
        ...
        MAP(values,1,2,1,0) = -dx / asREAL(12);
        MAP(values,1,2,1,1) = -dx / asREAL(12);
        ...
        MAP(values,1,2,2,0) = -1 / dz * dy * dx / asREAL(18);
        MAP(values,1,2,2,1) = -1 / dz * dy * dx / asREAL(18);
        ...
        MAP(values,2,0,0,1) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,2,0,1,1) = dz / asREAL(24);
        ...
        MAP(values,2,0,2,1) = dy / asREAL(24);
        ...
        MAP(values,2,1,0,1) = dz / asREAL(24);
        ...
        MAP(values,2,1,1,1) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,2,1,2,1) = -dx / asREAL(24);
        ...
        MAP(values,2,2,0,1) = dy / asREAL(24);
        ...
        MAP(values,2,2,1,1) = -dx / asREAL(24);
        ...
        MAP(values,2,2,2,1) = -1 / dz * dy * dx / asREAL(36);
        ...
        MAP(values,6,0,0,2) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,6,0,1,2) = dz / asREAL(24);
        ...
        MAP(values,6,0,2,2) = -dy / asREAL(24);
        ...
        MAP(values,6,1,0,2) = dz / asREAL(24);
        ...
        MAP(values,6,1,1,2) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,6,1,2,2) = dx / asREAL(24);
        ...
        MAP(values,6,2,0,2) = -dy / asREAL(24);
        ...
        MAP(values,6,2,1,2) = dx / asREAL(24);
        ...
        MAP(values,6,2,2,2) = -1 / dz * dy * dx / asREAL(36);
        ...
        MAP(values,7,0,0,2) = dz * dy / dx / asREAL(36);
        MAP(values,7,0,0,3) = dz * dy / dx / asREAL(36);
        ...
        MAP(values,7,0,1,2) = -dz / asREAL(24);
        MAP(values,7,0,1,3) = dz / asREAL(24);
        ...
        MAP(values,7,0,2,2) = dy / asREAL(24);
        MAP(values,7,0,2,3) = -dy / asREAL(24);
        ...
        MAP(values,7,1,0,2) = dz / asREAL(24);
        MAP(values,7,1,0,3) = -dz / asREAL(24);
        ...
        MAP(values,7,1,1,2) = -dz / dy * dx / asREAL(18);
        MAP(values,7,1,1,3) = -dz / dy * dx / asREAL(18);
        ...
        MAP(values,7,1,2,2) = dx / asREAL(12);
        MAP(values,7,1,2,3) = dx / asREAL(12);
        ...
        MAP(values,7,2,0,2) = -dy / asREAL(24);
        MAP(values,7,2,0,3) = dy / asREAL(24);
        ...
        MAP(values,7,2,1,2) = dx / asREAL(12);
        MAP(values,7,2,1,3) = dx / asREAL(12);
        ...
        MAP(values,7,2,2,2) = -1 / dz * dy * dx / asREAL(18);
        MAP(values,7,2,2,3) = -1 / dz * dy * dx / asREAL(18);
        ...
        MAP(values,8,0,0,3) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,8,0,1,3) = -dz / asREAL(24);
        ...
        MAP(values,8,0,2,3) = dy / asREAL(24);
        ...
        MAP(values,8,1,0,3) = -dz / asREAL(24);
        ...
        MAP(values,8,1,1,3) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,8,1,2,3) = dx / asREAL(24);
        ...
        MAP(values,8,2,0,3) = dy / asREAL(24);
        ...
        MAP(values,8,2,1,3) = dx / asREAL(24);
        ...
        MAP(values,8,2,2,3) = -1 / dz * dy * dx / asREAL(36);
        MAP(values,8,2,2,4) = 0;
        MAP(values,8,2,2,5) = 0;
        MAP(values,8,2,2,6) = 0;
        MAP(values,8,2,2,7) = 0;
        MAP(values,9,0,0,0) = -dz * dy / dx / asREAL(18);
        MAP(values,9,0,0,1) = 0;
        MAP(values,9,0,0,2) = 0;
        MAP(values,9,0,0,3) = 0;
        MAP(values,9,0,0,4) = -dz * dy / dx / asREAL(18);
        MAP(values,9,0,0,5) = 0;
        MAP(values,9,0,0,6) = 0;
        MAP(values,9,0,0,7) = 0;
        MAP(values,9,0,1,0) = -dz / asREAL(12);
        MAP(values,9,0,1,1) = 0;
        MAP(values,9,0,1,2) = 0;
        MAP(values,9,0,1,3) = 0;
        MAP(values,9,0,1,4) = -dz / asREAL(12);
        MAP(values,9,0,1,5) = 0;
        MAP(values,9,0,1,6) = 0;
        MAP(values,9,0,1,7) = 0;
        MAP(values,9,0,2,0) = -dy / asREAL(24);
        MAP(values,9,0,2,1) = 0;
        MAP(values,9,0,2,2) = 0;
        MAP(values,9,0,2,3) = 0;
        MAP(values,9,0,2,4) = dy / asREAL(24);
        MAP(values,9,0,2,5) = 0;
        MAP(values,9,0,2,6) = 0;
        MAP(values,9,0,2,7) = 0;
        MAP(values,9,1,0,0) = -dz / asREAL(12);
        MAP(values,9,1,0,1) = 0;
        MAP(values,9,1,0,2) = 0;
        MAP(values,9,1,0,3) = 0;
        MAP(values,9,1,0,4) = -dz / asREAL(12);
        MAP(values,9,1,0,5) = 0;
        MAP(values,9,1,0,6) = 0;
        MAP(values,9,1,0,7) = 0;
        MAP(values,9,1,1,0) = -dz / dy * dx / asREAL(18);
        MAP(values,9,1,1,1) = 0;
        MAP(values,9,1,1,2) = 0;
        MAP(values,9,1,1,3) = 0;
        MAP(values,9,1,1,4) = -dz / dy * dx / asREAL(18);
        MAP(values,9,1,1,5) = 0;
        MAP(values,9,1,1,6) = 0;
        MAP(values,9,1,1,7) = 0;
        MAP(values,9,1,2,0) = -dx / asREAL(24);
        MAP(values,9,1,2,1) = 0;
        MAP(values,9,1,2,2) = 0;
        MAP(values,9,1,2,3) = 0;
        MAP(values,9,1,2,4) = dx / asREAL(24);
        MAP(values,9,1,2,5) = 0;
        MAP(values,9,1,2,6) = 0;
        MAP(values,9,1,2,7) = 0;
        MAP(values,9,2,0,0) = dy / asREAL(24);
        MAP(values,9,2,0,1) = 0;
        MAP(values,9,2,0,2) = 0;
        MAP(values,9,2,0,3) = 0;
        MAP(values,9,2,0,4) = -dy / asREAL(24);
        MAP(values,9,2,0,5) = 0;
        MAP(values,9,2,0,6) = 0;
        MAP(values,9,2,0,7) = 0;
        MAP(values,9,2,1,0) = dx / asREAL(24);
        MAP(values,9,2,1,1) = 0;
        MAP(values,9,2,1,2) = 0;
        MAP(values,9,2,1,3) = 0;
        MAP(values,9,2,1,4) = -dx / asREAL(24);
        MAP(values,9,2,1,5) = 0;
        MAP(values,9,2,1,6) = 0;
        MAP(values,9,2,1,7) = 0;
        MAP(values,9,2,2,0) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,9,2,2,1) = 0;
        MAP(values,9,2,2,2) = 0;
        MAP(values,9,2,2,3) = 0;
        MAP(values,9,2,2,4) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,9,2,2,5) = 0;
        MAP(values,9,2,2,6) = 0;
        MAP(values,9,2,2,7) = 0;
        MAP(values,10,0,0,0) = dz * dy / dx / asREAL(18);
        MAP(values,10,0,0,1) = dz * dy / dx / asREAL(18);
        MAP(values,10,0,0,2) = 0;
        MAP(values,10,0,0,3) = 0;
        MAP(values,10,0,0,4) = dz * dy / dx / asREAL(18);
        MAP(values,10,0,0,5) = dz * dy / dx / asREAL(18);
        MAP(values,10,0,0,6) = 0;
        MAP(values,10,0,0,7) = 0;
        MAP(values,10,0,1,0) = dz / asREAL(12);
        MAP(values,10,0,1,1) = -dz / asREAL(12);
        MAP(values,10,0,1,2) = 0;
        MAP(values,10,0,1,3) = 0;
        MAP(values,10,0,1,4) = dz / asREAL(12);
        MAP(values,10,0,1,5) = -dz / asREAL(12);
        MAP(values,10,0,1,6) = 0;
        MAP(values,10,0,1,7) = 0;
        MAP(values,10,0,2,0) = dy / asREAL(24);
        MAP(values,10,0,2,1) = -dy / asREAL(24);
        MAP(values,10,0,2,2) = 0;
        MAP(values,10,0,2,3) = 0;
        MAP(values,10,0,2,4) = -dy / asREAL(24);
        MAP(values,10,0,2,5) = dy / asREAL(24);
        MAP(values,10,0,2,6) = 0;
        MAP(values,10,0,2,7) = 0;
        MAP(values,10,1,0,0) = -dz / asREAL(12);
        MAP(values,10,1,0,1) = dz / asREAL(12);
        MAP(values,10,1,0,2) = 0;
        MAP(values,10,1,0,3) = 0;
        MAP(values,10,1,0,4) = -dz / asREAL(12);
        MAP(values,10,1,0,5) = dz / asREAL(12);
        MAP(values,10,1,0,6) = 0;
        MAP(values,10,1,0,7) = 0;
        MAP(values,10,1,1,0) = -dz / dy * dx / asREAL(9);
        MAP(values,10,1,1,1) = -dz / dy * dx / asREAL(9);
        MAP(values,10,1,1,2) = 0;
        MAP(values,10,1,1,3) = 0;
        MAP(values,10,1,1,4) = -dz / dy * dx / asREAL(9);
        MAP(values,10,1,1,5) = -dz / dy * dx / asREAL(9);
        MAP(values,10,1,1,6) = 0;
        MAP(values,10,1,1,7) = 0;
        MAP(values,10,1,2,0) = -dx / asREAL(12);
        MAP(values,10,1,2,1) = -dx / asREAL(12);
        MAP(values,10,1,2,2) = 0;
        MAP(values,10,1,2,3) = 0;
        MAP(values,10,1,2,4) = dx / asREAL(12);
        MAP(values,10,1,2,5) = dx / asREAL(12);
        MAP(values,10,1,2,6) = 0;
        MAP(values,10,1,2,7) = 0;
        MAP(values,10,2,0,0) = dy / asREAL(24);
        MAP(values,10,2,0,1) = -dy / asREAL(24);
        MAP(values,10,2,0,2) = 0;
        MAP(values,10,2,0,3) = 0;
        MAP(values,10,2,0,4) = -dy / asREAL(24);
        MAP(values,10,2,0,5) = dy / asREAL(24);
        MAP(values,10,2,0,6) = 0;
        MAP(values,10,2,0,7) = 0;
        MAP(values,10,2,1,0) = dx / asREAL(12);
        MAP(values,10,2,1,1) = dx / asREAL(12);
        MAP(values,10,2,1,2) = 0;
        MAP(values,10,2,1,3) = 0;
        MAP(values,10,2,1,4) = -dx / asREAL(12);
        MAP(values,10,2,1,5) = -dx / asREAL(12);
        MAP(values,10,2,1,6) = 0;
        MAP(values,10,2,1,7) = 0;
        MAP(values,10,2,2,0) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,10,2,2,1) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,10,2,2,2) = 0;
        MAP(values,10,2,2,3) = 0;
        MAP(values,10,2,2,4) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,10,2,2,5) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,10,2,2,6) = 0;
        MAP(values,10,2,2,7) = 0;
        MAP(values,11,0,0,0) = 0;
        MAP(values,11,0,0,1) = -dz * dy / dx / asREAL(18);
        MAP(values,11,0,0,2) = 0;
        MAP(values,11,0,0,3) = 0;
        MAP(values,11,0,0,4) = 0;
        MAP(values,11,0,0,5) = -dz * dy / dx / asREAL(18);
        MAP(values,11,0,0,6) = 0;
        MAP(values,11,0,0,7) = 0;
        MAP(values,11,0,1,0) = 0;
        MAP(values,11,0,1,1) = dz / asREAL(12);
        MAP(values,11,0,1,2) = 0;
        MAP(values,11,0,1,3) = 0;
        MAP(values,11,0,1,4) = 0;
        MAP(values,11,0,1,5) = dz / asREAL(12);
        MAP(values,11,0,1,6) = 0;
        MAP(values,11,0,1,7) = 0;
        MAP(values,11,0,2,0) = 0;
        MAP(values,11,0,2,1) = dy / asREAL(24);
        MAP(values,11,0,2,2) = 0;
        MAP(values,11,0,2,3) = 0;
        MAP(values,11,0,2,4) = 0;
        MAP(values,11,0,2,5) = -dy / asREAL(24);
        MAP(values,11,0,2,6) = 0;
        MAP(values,11,0,2,7) = 0;
        MAP(values,11,1,0,0) = 0;
        MAP(values,11,1,0,1) = dz / asREAL(12);
        MAP(values,11,1,0,2) = 0;
        MAP(values,11,1,0,3) = 0;
        MAP(values,11,1,0,4) = 0;
        MAP(values,11,1,0,5) = dz / asREAL(12);
        MAP(values,11,1,0,6) = 0;
        MAP(values,11,1,0,7) = 0;
        MAP(values,11,1,1,0) = 0;
        MAP(values,11,1,1,1) = -dz / dy * dx / asREAL(18);
        MAP(values,11,1,1,2) = 0;
        MAP(values,11,1,1,3) = 0;
        MAP(values,11,1,1,4) = 0;
        MAP(values,11,1,1,5) = -dz / dy * dx / asREAL(18);
        MAP(values,11,1,1,6) = 0;
        MAP(values,11,1,1,7) = 0;
        MAP(values,11,1,2,0) = 0;
        MAP(values,11,1,2,1) = -dx / asREAL(24);
        MAP(values,11,1,2,2) = 0;
        MAP(values,11,1,2,3) = 0;
        MAP(values,11,1,2,4) = 0;
        MAP(values,11,1,2,5) = dx / asREAL(24);
        MAP(values,11,1,2,6) = 0;
        MAP(values,11,1,2,7) = 0;
        MAP(values,11,2,0,0) = 0;
        MAP(values,11,2,0,1) = -dy / asREAL(24);
        MAP(values,11,2,0,2) = 0;
        MAP(values,11,2,0,3) = 0;
        MAP(values,11,2,0,4) = 0;
        MAP(values,11,2,0,5) = dy / asREAL(24);
        MAP(values,11,2,0,6) = 0;
        MAP(values,11,2,0,7) = 0;
        MAP(values,11,2,1,0) = 0;
        MAP(values,11,2,1,1) = dx / asREAL(24);
        MAP(values,11,2,1,2) = 0;
        MAP(values,11,2,1,3) = 0;
        MAP(values,11,2,1,4) = 0;
        MAP(values,11,2,1,5) = -dx / asREAL(24);
        MAP(values,11,2,1,6) = 0;
        MAP(values,11,2,1,7) = 0;
        MAP(values,11,2,2,0) = 0;
        MAP(values,11,2,2,1) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,11,2,2,2) = 0;
        MAP(values,11,2,2,3) = 0;
        MAP(values,11,2,2,4) = 0;
        MAP(values,11,2,2,5) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,11,2,2,6) = 0;
        MAP(values,11,2,2,7) = 0;
        MAP(values,12,0,0,0) = -dz * dy / dx / asREAL(9);
        MAP(values,12,0,0,1) = 0;
        MAP(values,12,0,0,2) = -dz * dy / dx / asREAL(9);
        MAP(values,12,0,0,3) = 0;
        MAP(values,12,0,0,4) = -dz * dy / dx / asREAL(9);
        MAP(values,12,0,0,5) = 0;
        MAP(values,12,0,0,6) = -dz * dy / dx / asREAL(9);
        MAP(values,12,0,0,7) = 0;
        MAP(values,12,0,1,0) = -dz / asREAL(12);
        MAP(values,12,0,1,1) = 0;
        MAP(values,12,0,1,2) = dz / asREAL(12);
        MAP(values,12,0,1,3) = 0;
        MAP(values,12,0,1,4) = -dz / asREAL(12);
        MAP(values,12,0,1,5) = 0;
        MAP(values,12,0,1,6) = dz / asREAL(12);
        MAP(values,12,0,1,7) = 0;
        MAP(values,12,0,2,0) = -dy / asREAL(12);
        MAP(values,12,0,2,1) = 0;
        MAP(values,12,0,2,2) = -dy / asREAL(12);
        MAP(values,12,0,2,3) = 0;
        MAP(values,12,0,2,4) = dy / asREAL(12);
        MAP(values,12,0,2,5) = 0;
        MAP(values,12,0,2,6) = dy / asREAL(12);
        MAP(values,12,0,2,7) = 0;
        MAP(values,12,1,0,0) = dz / asREAL(12);
        MAP(values,12,1,0,1) = 0;
        MAP(values,12,1,0,2) = -dz / asREAL(12);
        MAP(values,12,1,0,3) = 0;
        MAP(values,12,1,0,4) = dz / asREAL(12);
        MAP(values,12,1,0,5) = 0;
        MAP(values,12,1,0,6) = -dz / asREAL(12);
        MAP(values,12,1,0,7) = 0;
        MAP(values,12,1,1,0) = dz / dy * dx / asREAL(18);
        MAP(values,12,1,1,1) = 0;
        MAP(values,12,1,1,2) = dz / dy * dx / asREAL(18);
        MAP(values,12,1,1,3) = 0;
        MAP(values,12,1,1,4) = dz / dy * dx / asREAL(18);
        MAP(values,12,1,1,5) = 0;
        MAP(values,12,1,1,6) = dz / dy * dx / asREAL(18);
        MAP(values,12,1,1,7) = 0;
        MAP(values,12,1,2,0) = dx / asREAL(24);
        MAP(values,12,1,2,1) = 0;
        MAP(values,12,1,2,2) = -dx / asREAL(24);
        MAP(values,12,1,2,3) = 0;
        MAP(values,12,1,2,4) = -dx / asREAL(24);
        MAP(values,12,1,2,5) = 0;
        MAP(values,12,1,2,6) = dx / asREAL(24);
        MAP(values,12,1,2,7) = 0;
        MAP(values,12,2,0,0) = dy / asREAL(12);
        MAP(values,12,2,0,1) = 0;
        MAP(values,12,2,0,2) = dy / asREAL(12);
        MAP(values,12,2,0,3) = 0;
        MAP(values,12,2,0,4) = -dy / asREAL(12);
        MAP(values,12,2,0,5) = 0;
        MAP(values,12,2,0,6) = -dy / asREAL(12);
        MAP(values,12,2,0,7) = 0;
        MAP(values,12,2,1,0) = dx / asREAL(24);
        MAP(values,12,2,1,1) = 0;
        MAP(values,12,2,1,2) = -dx / asREAL(24);
        MAP(values,12,2,1,3) = 0;
        MAP(values,12,2,1,4) = -dx / asREAL(24);
        MAP(values,12,2,1,5) = 0;
        MAP(values,12,2,1,6) = dx / asREAL(24);
        MAP(values,12,2,1,7) = 0;
        MAP(values,12,2,2,0) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,12,2,2,1) = 0;
        MAP(values,12,2,2,2) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,12,2,2,3) = 0;
        MAP(values,12,2,2,4) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,12,2,2,5) = 0;
        MAP(values,12,2,2,6) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,12,2,2,7) = 0;
        MAP(values,13,0,0,0) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,1) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,2) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,3) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,4) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,5) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,6) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,0,7) = dz * dy / dx / asREAL(9);
        MAP(values,13,0,1,0) = dz / asREAL(12);
        MAP(values,13,0,1,1) = -dz / asREAL(12);
        MAP(values,13,0,1,2) = -dz / asREAL(12);
        MAP(values,13,0,1,3) = dz / asREAL(12);
        MAP(values,13,0,1,4) = dz / asREAL(12);
        MAP(values,13,0,1,5) = -dz / asREAL(12);
        MAP(values,13,0,1,6) = -dz / asREAL(12);
        MAP(values,13,0,1,7) = dz / asREAL(12);
        MAP(values,13,0,2,0) = dy / asREAL(12);
        MAP(values,13,0,2,1) = -dy / asREAL(12);
        MAP(values,13,0,2,2) = dy / asREAL(12);
        MAP(values,13,0,2,3) = -dy / asREAL(12);
        MAP(values,13,0,2,4) = -dy / asREAL(12);
        MAP(values,13,0,2,5) = dy / asREAL(12);
        MAP(values,13,0,2,6) = -dy / asREAL(12);
        MAP(values,13,0,2,7) = dy / asREAL(12);
        MAP(values,13,1,0,0) = dz / asREAL(12);
        MAP(values,13,1,0,1) = -dz / asREAL(12);
        MAP(values,13,1,0,2) = -dz / asREAL(12);
        MAP(values,13,1,0,3) = dz / asREAL(12);
        MAP(values,13,1,0,4) = dz / asREAL(12);
        MAP(values,13,1,0,5) = -dz / asREAL(12);
        MAP(values,13,1,0,6) = -dz / asREAL(12);
        MAP(values,13,1,0,7) = dz / asREAL(12);
        MAP(values,13,1,1,0) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,1) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,2) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,3) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,4) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,5) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,6) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,1,7) = dz / dy * dx / asREAL(9);
        MAP(values,13,1,2,0) = dx / asREAL(12);
        MAP(values,13,1,2,1) = dx / asREAL(12);
        MAP(values,13,1,2,2) = -dx / asREAL(12);
        MAP(values,13,1,2,3) = -dx / asREAL(12);
        MAP(values,13,1,2,4) = -dx / asREAL(12);
        MAP(values,13,1,2,5) = -dx / asREAL(12);
        MAP(values,13,1,2,6) = dx / asREAL(12);
        MAP(values,13,1,2,7) = dx / asREAL(12);
        MAP(values,13,2,0,0) = dy / asREAL(12);
        MAP(values,13,2,0,1) = -dy / asREAL(12);
        MAP(values,13,2,0,2) = dy / asREAL(12);
        MAP(values,13,2,0,3) = -dy / asREAL(12);
        MAP(values,13,2,0,4) = -dy / asREAL(12);
        MAP(values,13,2,0,5) = dy / asREAL(12);
        MAP(values,13,2,0,6) = -dy / asREAL(12);
        MAP(values,13,2,0,7) = dy / asREAL(12);
        MAP(values,13,2,1,0) = dx / asREAL(12);
        MAP(values,13,2,1,1) = dx / asREAL(12);
        MAP(values,13,2,1,2) = -dx / asREAL(12);
        MAP(values,13,2,1,3) = -dx / asREAL(12);
        MAP(values,13,2,1,4) = -dx / asREAL(12);
        MAP(values,13,2,1,5) = -dx / asREAL(12);
        MAP(values,13,2,1,6) = dx / asREAL(12);
        MAP(values,13,2,1,7) = dx / asREAL(12);
        MAP(values,13,2,2,0) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,1) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,2) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,3) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,4) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,5) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,6) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,13,2,2,7) = 1 / dz * dy * dx / asREAL(9);
        MAP(values,14,0,0,0) = 0;
        MAP(values,14,0,0,1) = -dz * dy / dx / asREAL(9);
        MAP(values,14,0,0,2) = 0;
        MAP(values,14,0,0,3) = -dz * dy / dx / asREAL(9);
        MAP(values,14,0,0,4) = 0;
        MAP(values,14,0,0,5) = -dz * dy / dx / asREAL(9);
        MAP(values,14,0,0,6) = 0;
        MAP(values,14,0,0,7) = -dz * dy / dx / asREAL(9);
        MAP(values,14,0,1,0) = 0;
        MAP(values,14,0,1,1) = dz / asREAL(12);
        MAP(values,14,0,1,2) = 0;
        MAP(values,14,0,1,3) = -dz / asREAL(12);
        MAP(values,14,0,1,4) = 0;
        MAP(values,14,0,1,5) = dz / asREAL(12);
        MAP(values,14,0,1,6) = 0;
        MAP(values,14,0,1,7) = -dz / asREAL(12);
        MAP(values,14,0,2,0) = 0;
        MAP(values,14,0,2,1) = dy / asREAL(12);
        MAP(values,14,0,2,2) = 0;
        MAP(values,14,0,2,3) = dy / asREAL(12);
        MAP(values,14,0,2,4) = 0;
        MAP(values,14,0,2,5) = -dy / asREAL(12);
        MAP(values,14,0,2,6) = 0;
        MAP(values,14,0,2,7) = -dy / asREAL(12);
        MAP(values,14,1,0,0) = 0;
        MAP(values,14,1,0,1) = -dz / asREAL(12);
        MAP(values,14,1,0,2) = 0;
        MAP(values,14,1,0,3) = dz / asREAL(12);
        MAP(values,14,1,0,4) = 0;
        MAP(values,14,1,0,5) = -dz / asREAL(12);
        MAP(values,14,1,0,6) = 0;
        MAP(values,14,1,0,7) = dz / asREAL(12);
        MAP(values,14,1,1,0) = 0;
        MAP(values,14,1,1,1) = dz / dy * dx / asREAL(18);
        MAP(values,14,1,1,2) = 0;
        MAP(values,14,1,1,3) = dz / dy * dx / asREAL(18);
        MAP(values,14,1,1,4) = 0;
        MAP(values,14,1,1,5) = dz / dy * dx / asREAL(18);
        MAP(values,14,1,1,6) = 0;
        MAP(values,14,1,1,7) = dz / dy * dx / asREAL(18);
        MAP(values,14,1,2,0) = 0;
        MAP(values,14,1,2,1) = dx / asREAL(24);
        MAP(values,14,1,2,2) = 0;
        MAP(values,14,1,2,3) = -dx / asREAL(24);
        MAP(values,14,1,2,4) = 0;
        MAP(values,14,1,2,5) = -dx / asREAL(24);
        MAP(values,14,1,2,6) = 0;
        MAP(values,14,1,2,7) = dx / asREAL(24);
        MAP(values,14,2,0,0) = 0;
        MAP(values,14,2,0,1) = -dy / asREAL(12);
        MAP(values,14,2,0,2) = 0;
        MAP(values,14,2,0,3) = -dy / asREAL(12);
        MAP(values,14,2,0,4) = 0;
        MAP(values,14,2,0,5) = dy / asREAL(12);
        MAP(values,14,2,0,6) = 0;
        MAP(values,14,2,0,7) = dy / asREAL(12);
        MAP(values,14,2,1,0) = 0;
        MAP(values,14,2,1,1) = dx / asREAL(24);
        MAP(values,14,2,1,2) = 0;
        MAP(values,14,2,1,3) = -dx / asREAL(24);
        MAP(values,14,2,1,4) = 0;
        MAP(values,14,2,1,5) = -dx / asREAL(24);
        MAP(values,14,2,1,6) = 0;
        MAP(values,14,2,1,7) = dx / asREAL(24);
        MAP(values,14,2,2,0) = 0;
        MAP(values,14,2,2,1) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,14,2,2,2) = 0;
        MAP(values,14,2,2,3) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,14,2,2,4) = 0;
        MAP(values,14,2,2,5) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,14,2,2,6) = 0;
        MAP(values,14,2,2,7) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,15,0,0,0) = 0;
        MAP(values,15,0,0,1) = 0;
        MAP(values,15,0,0,2) = -dz * dy / dx / asREAL(18);
        MAP(values,15,0,0,3) = 0;
        MAP(values,15,0,0,4) = 0;
        MAP(values,15,0,0,5) = 0;
        MAP(values,15,0,0,6) = -dz * dy / dx / asREAL(18);
        MAP(values,15,0,0,7) = 0;
        MAP(values,15,0,1,0) = 0;
        MAP(values,15,0,1,1) = 0;
        MAP(values,15,0,1,2) = dz / asREAL(12);
        MAP(values,15,0,1,3) = 0;
        MAP(values,15,0,1,4) = 0;
        MAP(values,15,0,1,5) = 0;
        MAP(values,15,0,1,6) = dz / asREAL(12);
        MAP(values,15,0,1,7) = 0;
        MAP(values,15,0,2,0) = 0;
        MAP(values,15,0,2,1) = 0;
        MAP(values,15,0,2,2) = -dy / asREAL(24);
        MAP(values,15,0,2,3) = 0;
        MAP(values,15,0,2,4) = 0;
        MAP(values,15,0,2,5) = 0;
        MAP(values,15,0,2,6) = dy / asREAL(24);
        MAP(values,15,0,2,7) = 0;
        MAP(values,15,1,0,0) = 0;
        MAP(values,15,1,0,1) = 0;
        MAP(values,15,1,0,2) = dz / asREAL(12);
        MAP(values,15,1,0,3) = 0;
        MAP(values,15,1,0,4) = 0;
        MAP(values,15,1,0,5) = 0;
        MAP(values,15,1,0,6) = dz / asREAL(12);
        MAP(values,15,1,0,7) = 0;
        MAP(values,15,1,1,0) = 0;
        MAP(values,15,1,1,1) = 0;
        MAP(values,15,1,1,2) = -dz / dy * dx / asREAL(18);
        MAP(values,15,1,1,3) = 0;
        MAP(values,15,1,1,4) = 0;
        MAP(values,15,1,1,5) = 0;
        MAP(values,15,1,1,6) = -dz / dy * dx / asREAL(18);
        MAP(values,15,1,1,7) = 0;
        MAP(values,15,1,2,0) = 0;
        MAP(values,15,1,2,1) = 0;
        MAP(values,15,1,2,2) = dx / asREAL(24);
        MAP(values,15,1,2,3) = 0;
        MAP(values,15,1,2,4) = 0;
        MAP(values,15,1,2,5) = 0;
        MAP(values,15,1,2,6) = -dx / asREAL(24);
        MAP(values,15,1,2,7) = 0;
        MAP(values,15,2,0,0) = 0;
        MAP(values,15,2,0,1) = 0;
        MAP(values,15,2,0,2) = dy / asREAL(24);
        MAP(values,15,2,0,3) = 0;
        MAP(values,15,2,0,4) = 0;
        MAP(values,15,2,0,5) = 0;
        MAP(values,15,2,0,6) = -dy / asREAL(24);
        MAP(values,15,2,0,7) = 0;
        MAP(values,15,2,1,0) = 0;
        MAP(values,15,2,1,1) = 0;
        MAP(values,15,2,1,2) = -dx / asREAL(24);
        MAP(values,15,2,1,3) = 0;
        MAP(values,15,2,1,4) = 0;
        MAP(values,15,2,1,5) = 0;
        MAP(values,15,2,1,6) = dx / asREAL(24);
        MAP(values,15,2,1,7) = 0;
        MAP(values,15,2,2,0) = 0;
        MAP(values,15,2,2,1) = 0;
        MAP(values,15,2,2,2) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,15,2,2,3) = 0;
        MAP(values,15,2,2,4) = 0;
        MAP(values,15,2,2,5) = 0;
        MAP(values,15,2,2,6) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,15,2,2,7) = 0;
        MAP(values,16,0,0,0) = 0;
        MAP(values,16,0,0,1) = 0;
        MAP(values,16,0,0,2) = dz * dy / dx / asREAL(18);
        MAP(values,16,0,0,3) = dz * dy / dx / asREAL(18);
        MAP(values,16,0,0,4) = 0;
        MAP(values,16,0,0,5) = 0;
        MAP(values,16,0,0,6) = dz * dy / dx / asREAL(18);
        MAP(values,16,0,0,7) = dz * dy / dx / asREAL(18);
        MAP(values,16,0,1,0) = 0;
        MAP(values,16,0,1,1) = 0;
        MAP(values,16,0,1,2) = -dz / asREAL(12);
        MAP(values,16,0,1,3) = dz / asREAL(12);
        MAP(values,16,0,1,4) = 0;
        MAP(values,16,0,1,5) = 0;
        MAP(values,16,0,1,6) = -dz / asREAL(12);
        MAP(values,16,0,1,7) = dz / asREAL(12);
        MAP(values,16,0,2,0) = 0;
        MAP(values,16,0,2,1) = 0;
        MAP(values,16,0,2,2) = dy / asREAL(24);
        MAP(values,16,0,2,3) = -dy / asREAL(24);
        MAP(values,16,0,2,4) = 0;
        MAP(values,16,0,2,5) = 0;
        MAP(values,16,0,2,6) = -dy / asREAL(24);
        MAP(values,16,0,2,7) = dy / asREAL(24);
        MAP(values,16,1,0,0) = 0;
        MAP(values,16,1,0,1) = 0;
        MAP(values,16,1,0,2) = dz / asREAL(12);
        MAP(values,16,1,0,3) = -dz / asREAL(12);
        MAP(values,16,1,0,4) = 0;
        MAP(values,16,1,0,5) = 0;
        MAP(values,16,1,0,6) = dz / asREAL(12);
        MAP(values,16,1,0,7) = -dz / asREAL(12);
        MAP(values,16,1,1,0) = 0;
        MAP(values,16,1,1,1) = 0;
        MAP(values,16,1,1,2) = -dz / dy * dx / asREAL(9);
        MAP(values,16,1,1,3) = -dz / dy * dx / asREAL(9);
        MAP(values,16,1,1,4) = 0;
        MAP(values,16,1,1,5) = 0;
        MAP(values,16,1,1,6) = -dz / dy * dx / asREAL(9);
        MAP(values,16,1,1,7) = -dz / dy * dx / asREAL(9);
        MAP(values,16,1,2,0) = 0;
        MAP(values,16,1,2,1) = 0;
        MAP(values,16,1,2,2) = dx / asREAL(12);
        MAP(values,16,1,2,3) = dx / asREAL(12);
        MAP(values,16,1,2,4) = 0;
        MAP(values,16,1,2,5) = 0;
        MAP(values,16,1,2,6) = -dx / asREAL(12);
        MAP(values,16,1,2,7) = -dx / asREAL(12);
        MAP(values,16,2,0,0) = 0;
        MAP(values,16,2,0,1) = 0;
        MAP(values,16,2,0,2) = dy / asREAL(24);
        MAP(values,16,2,0,3) = -dy / asREAL(24);
        MAP(values,16,2,0,4) = 0;
        MAP(values,16,2,0,5) = 0;
        MAP(values,16,2,0,6) = -dy / asREAL(24);
        MAP(values,16,2,0,7) = dy / asREAL(24);
        MAP(values,16,2,1,0) = 0;
        MAP(values,16,2,1,1) = 0;
        MAP(values,16,2,1,2) = -dx / asREAL(12);
        MAP(values,16,2,1,3) = -dx / asREAL(12);
        MAP(values,16,2,1,4) = 0;
        MAP(values,16,2,1,5) = 0;
        MAP(values,16,2,1,6) = dx / asREAL(12);
        MAP(values,16,2,1,7) = dx / asREAL(12);
        MAP(values,16,2,2,0) = 0;
        MAP(values,16,2,2,1) = 0;
        MAP(values,16,2,2,2) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,16,2,2,3) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,16,2,2,4) = 0;
        MAP(values,16,2,2,5) = 0;
        MAP(values,16,2,2,6) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,16,2,2,7) = 1 / dz * dy * dx / asREAL(18);
        MAP(values,17,0,0,0) = 0;
        MAP(values,17,0,0,1) = 0;
        MAP(values,17,0,0,2) = 0;
        MAP(values,17,0,0,3) = -dz * dy / dx / asREAL(18);
        MAP(values,17,0,0,4) = 0;
        MAP(values,17,0,0,5) = 0;
        MAP(values,17,0,0,6) = 0;
        MAP(values,17,0,0,7) = -dz * dy / dx / asREAL(18);
        MAP(values,17,0,1,0) = 0;
        MAP(values,17,0,1,1) = 0;
        MAP(values,17,0,1,2) = 0;
        MAP(values,17,0,1,3) = -dz / asREAL(12);
        MAP(values,17,0,1,4) = 0;
        MAP(values,17,0,1,5) = 0;
        MAP(values,17,0,1,6) = 0;
        MAP(values,17,0,1,7) = -dz / asREAL(12);
        MAP(values,17,0,2,0) = 0;
        MAP(values,17,0,2,1) = 0;
        MAP(values,17,0,2,2) = 0;
        MAP(values,17,0,2,3) = dy / asREAL(24);
        MAP(values,17,0,2,4) = 0;
        MAP(values,17,0,2,5) = 0;
        MAP(values,17,0,2,6) = 0;
        MAP(values,17,0,2,7) = -dy / asREAL(24);
        MAP(values,17,1,0,0) = 0;
        MAP(values,17,1,0,1) = 0;
        MAP(values,17,1,0,2) = 0;
        MAP(values,17,1,0,3) = -dz / asREAL(12);
        MAP(values,17,1,0,4) = 0;
        MAP(values,17,1,0,5) = 0;
        MAP(values,17,1,0,6) = 0;
        MAP(values,17,1,0,7) = -dz / asREAL(12);
        MAP(values,17,1,1,0) = 0;
        MAP(values,17,1,1,1) = 0;
        MAP(values,17,1,1,2) = 0;
        MAP(values,17,1,1,3) = -dz / dy * dx / asREAL(18);
        MAP(values,17,1,1,4) = 0;
        MAP(values,17,1,1,5) = 0;
        MAP(values,17,1,1,6) = 0;
        MAP(values,17,1,1,7) = -dz / dy * dx / asREAL(18);
        MAP(values,17,1,2,0) = 0;
        MAP(values,17,1,2,1) = 0;
        MAP(values,17,1,2,2) = 0;
        MAP(values,17,1,2,3) = dx / asREAL(24);
        MAP(values,17,1,2,4) = 0;
        MAP(values,17,1,2,5) = 0;
        MAP(values,17,1,2,6) = 0;
        MAP(values,17,1,2,7) = -dx / asREAL(24);
        MAP(values,17,2,0,0) = 0;
        MAP(values,17,2,0,1) = 0;
        MAP(values,17,2,0,2) = 0;
        MAP(values,17,2,0,3) = -dy / asREAL(24);
        MAP(values,17,2,0,4) = 0;
        MAP(values,17,2,0,5) = 0;
        MAP(values,17,2,0,6) = 0;
        MAP(values,17,2,0,7) = dy / asREAL(24);
        MAP(values,17,2,1,0) = 0;
        MAP(values,17,2,1,1) = 0;
        MAP(values,17,2,1,2) = 0;
        MAP(values,17,2,1,3) = -dx / asREAL(24);
        MAP(values,17,2,1,4) = 0;
        MAP(values,17,2,1,5) = 0;
        MAP(values,17,2,1,6) = 0;
        MAP(values,17,2,1,7) = dx / asREAL(24);
        MAP(values,17,2,2,0) = 0;
        MAP(values,17,2,2,1) = 0;
        MAP(values,17,2,2,2) = 0;
        MAP(values,17,2,2,3) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,17,2,2,4) = 0;
        MAP(values,17,2,2,5) = 0;
        MAP(values,17,2,2,6) = 0;
        MAP(values,17,2,2,7) = 1 / dz * dy * dx / asREAL(36);
        MAP(values,18,0,0,0) = 0;
        MAP(values,18,0,0,1) = 0;
        MAP(values,18,0,0,2) = 0;
        MAP(values,18,0,0,3) = 0;
        MAP(values,18,0,0,4) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,18,0,1,4) = -dz / asREAL(24);
        ...
        MAP(values,18,0,2,4) = dy / asREAL(24);
        ...
        MAP(values,18,1,0,4) = -dz / asREAL(24);
        ...
        MAP(values,18,1,1,4) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,18,1,2,4) = dx / asREAL(24);
        ...
        MAP(values,18,2,0,4) = dy / asREAL(24);
        ...
        MAP(values,18,2,1,4) = dx / asREAL(24);
        ...
        MAP(values,18,2,2,4) = -1 / dz * dy * dx / asREAL(36);
        ...
        MAP(values,19,0,0,4) = dz * dy / dx / asREAL(36);
        MAP(values,19,0,0,5) = dz * dy / dx / asREAL(36);
        ...
        MAP(values,19,0,1,4) = dz / asREAL(24);
        MAP(values,19,0,1,5) = -dz / asREAL(24);
        ...
        MAP(values,19,0,2,4) = -dy / asREAL(24);
        MAP(values,19,0,2,5) = dy / asREAL(24);
        ...
        MAP(values,19,1,0,4) = -dz / asREAL(24);
        MAP(values,19,1,0,5) = dz / asREAL(24);
        ...
        MAP(values,19,1,1,4) = -dz / dy * dx / asREAL(18);
        MAP(values,19,1,1,5) = -dz / dy * dx / asREAL(18);
        ...
        MAP(values,19,1,2,4) = dx / asREAL(12);
        MAP(values,19,1,2,5) = dx / asREAL(12);
        ...
        MAP(values,19,2,0,4) = dy / asREAL(24);
        MAP(values,19,2,0,5) = -dy / asREAL(24);
        ...
        MAP(values,19,2,1,4) = dx / asREAL(12);
        MAP(values,19,2,1,5) = dx / asREAL(12);
        ...
        MAP(values,19,2,2,4) = -1 / dz * dy * dx / asREAL(18);
        MAP(values,19,2,2,5) = -1 / dz * dy * dx / asREAL(18);
        ...
        MAP(values,20,0,0,5) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,20,0,1,5) = dz / asREAL(24);
        ...
        MAP(values,20,0,2,5) = -dy / asREAL(24);
        ...
        MAP(values,20,1,0,5) = dz / asREAL(24);
        ...
        MAP(values,20,1,1,5) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,20,1,2,5) = dx / asREAL(24);
        ...
        MAP(values,20,2,0,5) = -dy / asREAL(24);
        ...
        MAP(values,20,2,1,5) = dx / asREAL(24);
        ...
        MAP(values,20,2,2,5) = -1 / dz * dy * dx / asREAL(36);
        ...
        MAP(values,24,0,0,6) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,24,0,1,6) = dz / asREAL(24);
        ...
        MAP(values,24,0,2,6) = dy / asREAL(24);
        ...
        MAP(values,24,1,0,6) = dz / asREAL(24);
        ...
        MAP(values,24,1,1,6) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,24,1,2,6) = -dx / asREAL(24);
        ...
        MAP(values,24,2,0,6) = dy / asREAL(24);
        ...
        MAP(values,24,2,1,6) = -dx / asREAL(24);
        ...
        MAP(values,24,2,2,6) = -1 / dz * dy * dx / asREAL(36);
        ...
        MAP(values,25,0,0,6) = dz * dy / dx / asREAL(36);
        MAP(values,25,0,0,7) = dz * dy / dx / asREAL(36);
        ...
        MAP(values,25,0,1,6) = -dz / asREAL(24);
        MAP(values,25,0,1,7) = dz / asREAL(24);
        ...
        MAP(values,25,0,2,6) = -dy / asREAL(24);
        MAP(values,25,0,2,7) = dy / asREAL(24);
        ...
        MAP(values,25,1,0,6) = dz / asREAL(24);
        MAP(values,25,1,0,7) = -dz / asREAL(24);
        ...
        MAP(values,25,1,1,6) = -dz / dy * dx / asREAL(18);
        MAP(values,25,1,1,7) = -dz / dy * dx / asREAL(18);
        ...
        MAP(values,25,1,2,6) = -dx / asREAL(12);
        MAP(values,25,1,2,7) = -dx / asREAL(12);
        ...
        MAP(values,25,2,0,6) = dy / asREAL(24);
        MAP(values,25,2,0,7) = -dy / asREAL(24);
        ...
        MAP(values,25,2,1,6) = -dx / asREAL(12);
        MAP(values,25,2,1,7) = -dx / asREAL(12);
        ...
        MAP(values,25,2,2,6) = -1 / dz * dy * dx / asREAL(18);
        MAP(values,25,2,2,7) = -1 / dz * dy * dx / asREAL(18);
        ...
        MAP(values,26,0,0,7) = -dz * dy / dx / asREAL(36);
        ...
        MAP(values,26,0,1,7) = -dz / asREAL(24);
        ...
        MAP(values,26,0,2,7) = -dy / asREAL(24);
        ...
        MAP(values,26,1,0,7) = -dz / asREAL(24);
        ...
        MAP(values,26,1,1,7) = -dz / dy * dx / asREAL(36);
        ...
        MAP(values,26,1,2,7) = -dx / asREAL(24);
        ...
        MAP(values,26,2,0,7) = -dy / asREAL(24);
        ...
        MAP(values,26,2,1,7) = -dx / asREAL(24);
        ...
        MAP(values,26,2,2,7) = -1 / dz * dy * dx / asREAL(36);
    }
};